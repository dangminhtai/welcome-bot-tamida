...
const { SlashCommandBuilder, PermissionFlagsBits, EmbedBuilder } = discord;
...
export async function execute(interaction) {
    ...
    try {
        ...
        const embed = new EmbedBuilder()
            ...
            .setColor('#ff0000')
            .addFields({ name: 'Đối tượng', value: `${targetUser.tag} (ID: ${targetUser.id})`, inline: false }, { name: 'Lý do', value: reason, inline: false }, { name: 'Dọn dẹp', value: 'Đã xóa toàn bộ tin nhắn trong 7 ngày qua', inline: false })
            .setTimestamp()
